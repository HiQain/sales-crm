  ...
  return (
    <div className="relative">
      ...
      <select
        ...
        className="appearance-none bg-white/30 backdrop-blur-[12px] border border-white/20 pl-10 pr-9 py-2 rounded-xl text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 shadow-sm transition-all min-w-[150px]"
      >
